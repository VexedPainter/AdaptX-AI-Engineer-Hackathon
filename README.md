<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:6366f1,100:a855f7&height=220&section=header&text=Constrained%20Structured%20Extraction&fontSize=36&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=at%20Scale&descSize=18&descAlignY=55&descColor=c4b5fd"/>

<div align="center">

<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=6366F1&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=120&lines=%F0%9F%A7%AC+10-Stage+AI+Extraction+Pipeline;%F0%9F%8F%86+100%25+Schema+Validity+%7C+Zero+Regex;%E2%9A%A1+4-Tier+LLM+Fallback+%7C+AES-256+Encrypted" alt="Typing SVG" /></a>

<br/>

![TypeScript](https://img.shields.io/badge/TypeScript-5.x-3178C6?style=for-the-badge&logo=typescript&logoColor=white)
![Node.js](https://img.shields.io/badge/Node.js-20+-339933?style=for-the-badge&logo=node.js&logoColor=white)
![Mistral AI](https://img.shields.io/badge/Mistral_AI-Primary-FF7000?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white)
![Zod](https://img.shields.io/badge/Zod-Schema_Validated-3068B7?style=for-the-badge&logo=zod&logoColor=white)
![Express](https://img.shields.io/badge/Express.js-Gateway-000000?style=for-the-badge&logo=express&logoColor=white)
![OpenTelemetry](https://img.shields.io/badge/OpenTelemetry-Traced-F5A800?style=for-the-badge&logo=opentelemetry&logoColor=white)

<br/>

<a href="#-quick-start">
  <img src="https://img.shields.io/badge/▶_Quick_Start-6366f1?style=for-the-badge&logoColor=white" alt="Quick Start"/>
</a>
<a href="#-architecture">
  <img src="https://img.shields.io/badge/🏗_Architecture-8b5cf6?style=for-the-badge&logoColor=white" alt="Architecture"/>
</a>
<a href="#-evaluation-results">
  <img src="https://img.shields.io/badge/📊_Results-a855f7?style=for-the-badge&logoColor=white" alt="Results"/>
</a>
<a href="#-live-demo">
  <img src="https://img.shields.io/badge/🖥_Live_Demo-c084fc?style=for-the-badge&logoColor=white" alt="Live Demo"/>
</a>
<a href="#-deployment">
  <img src="https://img.shields.io/badge/☁_Deploy-d8b4fe?style=for-the-badge&logoColor=black" alt="Deploy"/>
</a>
...
<img src="https://img.shields.io/badge/100%25-Success_Rate-22c55e?style=for-the-badge" /><br/>
<sub><b>Schema Validity</b></sub><br/>
<sup>20-doc official eval</sup>
</td>
<td align="center" width="20%">
<img src="https://img.shields.io/badge/4_Tier-LLM_Fallback-6366f1?style=for-the-badge" /><br/>
<sub><b>Zero Downtime</b></sub><br/>
<sup>Mistral→Cerebras→Groq→Gemini</sup>
</td>
<td align="center" width="20%">
<img src="https://img.shields.io/badge/AES_256-Encrypted-ef4444?style=for-the-badge" /><br/>
<sub><b>At-Rest Security</b></sub><br/>
<sup>GCM authenticated</sup>
</td>
<td align="center" width="20%">
<img src="https://img.shields.io/badge/Dual-Guardrails-f59e0b?style=for-the-badge" /><br/>
<sub><b>Pre & Post Guard</b></sub><br/>
<sup>Hallucination detection</sup>
</td>
<td align="center" width="20%">
<img src="https://img.shields.io/badge/$0.0006-Per_Document-10b981?style=for-the-badge" /><br/>
...
graph TB
  ...
  subgraph Pipeline["⚙️ 10-Stage Extraction Pipeline"]
    S1["📥 Stage 1: Ingestion"]
    S2["✂️ Stage 2: Chunking"]
    S3["🔍 Stage 3: Retrieval"]
    S4["📝 Stage 4: Prompt Assembly"]
    S5A["🛡️ Stage 5a: Pre-Guard"]
    S6["🤖 Stage 6: LLM Extraction"]
    S5B["🛡️ Stage 5b: Post-Guard"]
    S7["🔗 Stage 7: Chunk Merge"]
    S8["✅ Stage 8: Validation"]
    S1 --> S2 --> S3 --> S4 --> S5A --> S6 --> S5B --> S7 --> S8
  end

  subgraph Output["💾 Output Layer"]
    S9["📋 Stage 9: Failure Logger"]
    S10A["🔒 Stage 10a: Encrypted Store"]
    S10B["⚠️ Stage 10b: Flagged Queue"]
  end

  subgraph Observe["📊 Observability — OpenTelemetry"]
    OT_T["Distributed Traces"]
    OT_M["Metrics & Cost"]
    OT_C["Correlation Propagation"]
  end

  subgraph Vector["🗄️ Qdrant Vector Store"]
    QD["few_shot_examples"]
    QE["TF-IDF Embeddings"]
  end

  GW_CORR --> S1
  S3 -.->|"similarity search"| QD
  QE -.->|"embed chunks"| S3
  S8 -->|"✅ valid"| S10A
  S8 -->|"❌ failed 3x"| S9
  S8 -->|"🔄 retry"| S4
  S9 --> S10B
  Pipeline -.->|"spans"| OT_T
  Pipeline -.->|"metrics"| OT_M
  GW_CORR -.->|"correlationId"| OT_C

  style Gateway fill:#1e1b4b,stroke:#6366f1,color:#e0e7ff
  style Pipeline fill:#1a1a2e,stroke:#8b5cf6,color:#e0e7ff
  style Output fill:#1e1b4b,stroke:#a855f7,color:#e0e7ff
  style Observe fill:#1c1917,stroke:#f59e0b,color:#fef3c7
  style Vector fill:#1a2332,stroke:#22d3ee,color:#cffafe
```
...
### 📑 Contracts
![](https://img.shields.io/badge/8_/_8-100%25-22c55e?style=flat-square&labelColor=1a1a2e)
...
### 💬 Chat Logs
![](https://img.shields.io/badge/6_/_6-100%25-22c55e?style=flat-square&labelColor=1a1a2e)
...
![Node.js](https://img.shields.io/badge/Node.js-≥_20.0.0-339933?style=flat-square&logo=node.js&logoColor=white)
![npm](https://img.shields.io/badge/npm-≥_9-CB3837?style=flat-square&logo=npm&logoColor=white)
...
<td align="center" width="100">
<img src="https://cdn.simpleicons.org/zod/3068B7" width="40" /><br/>
<sub><b>Zod</b></sub>
</td>
</tr>
<tr>
