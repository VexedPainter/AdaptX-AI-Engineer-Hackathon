...
*Generated: 2026-07-24T13:50:02.885Z*
*Mode: SUBSET (40 docs)*

## Executive Summary

- **Total Documents Processed**: 40
- **Schema-Valid Outputs**: 38
- **Success Rate**: **95.0%**
- **Average Latency**: 65.11s (p95)
- **Average Retries**: 1.00 per document
- **Average Cost**: $0.0008 per document
- **Total Evaluation Time**: 990.6s (~16.5 minutes)
...
|---|---|---|---|
| contract | 16 | 14 | 87.5% |
| chat_log | 12 | 12 | 100.0% |
| support_ticket | 12 | 12 | 100.0% |

## Failure Analysis

Distribution of failures across the pipeline:

- **wrong_type**: 159 occurrences
- **missing_field**: 136 occurrences
- **merge_conflict**: 18 occurrences
...
#### Document: `f648a4dc-964e-482c-b73c-73807755168a` (contract)
- **Retries Exhausted**: 3
- **Errors**:
...
#### Document: `99ee508e-5744-4804-9519-039d808c2379` (contract)
- **Retries Exhausted**: 3
- **Errors**:
  - [validation] wrong_type: Validation failed at path "expirationDate": Expected string, received null
  - [validation] missing_field: Validation failed at path "paymentTerms.3.amount": Required
...
**Document**: `86b45c5c-cd86-48e0-b406-c65e44fa848d` (contract)
**Latency**: 7646ms | **Retries**: 0 | **Tokens**: 3725
