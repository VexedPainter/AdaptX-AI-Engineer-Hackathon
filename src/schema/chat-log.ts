...
export const ChatParticipantSchema = z.object({
  name: z.string().describe('Display name or username of the participant'),
...
export const DiscussionTopicSchema = z.object({
  topic: z.string().describe('Brief description of the topic discussed'),
...
export const ChatLogSchema = z.object({
  conversationId: z.string().describe('Identifier for the conversation'),
  platform: z.enum(['slack', 'teams', 'live_chat', 'email_thread', 'discord', 'other'])
    .describe('Platform where the conversation took place'),
  startTime: z.string().describe('When the conversation started (ISO 8601 or descriptive)'),
  ...
  summary: z.string().describe('Brief summary of the entire conversation'),
